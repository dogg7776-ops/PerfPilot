...
require("app/build.gradle.kts", 'versionName = "1.0.0-beta8-k90-usability"', "beta8 usability version")
...
require("app/src/main/java/com/oai/perfpilot/RuntimeMetricsReader.kt", "gpu_utilization", "GED GPU utilization fallback")
