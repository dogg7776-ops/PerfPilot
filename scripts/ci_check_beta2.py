...
require("app/build.gradle.kts", 'versionName = "1.0.0-beta6-k90-telemetryfix"', "beta6 telemetry version")
...
require("app/src/main/java/com/oai/perfpilot/RuntimeMetricsReader.kt", "STACK[- ]?OPP", "MT6993 STACK OPP GPU probe")
