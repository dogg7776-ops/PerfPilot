...
require("app/build.gradle.kts", 'versionName = "1.0.0-beta5-k90-shizukucompat"', "beta5 Shizuku compatibility version")
...
require("app/src/main/java/com/oai/perfpilot/RuntimeMetricsReader.kt", "/proc/gpufreqv2/gpufreq_status", "MT6993 GPU frequency fallback")
require("app/src/main/java/com/oai/perfpilot/RuntimeMetricsReader.kt", "dumpsys thermalservice", "thermalservice temperature fallback")
