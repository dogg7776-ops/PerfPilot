...
require("app/build.gradle.kts", 'versionName = "1.0.0-beta7-k90-gpufix"', "beta7 GPU telemetry version")
...
require("app/src/main/java/com/oai/perfpilot/RuntimeMetricsReader.kt", "find \"${d}root\" -maxdepth 9", "GPU deep sysfs discovery")
